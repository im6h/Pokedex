...
public class Common {
    public static String URL = "https://raw.githubusercontent.com/Biuni/PokemonGO-Pokedex/master/";

    public static final String KEY_ENABLE_HOME = "enable_home";
    public static List<Pokemon> mListPokemon = new ArrayList<>();
    ...
    public static Pokemon findPokemonByNum(String num) {
        for(Pokemon pokemon : mListPokemon)
        {
